...
$types = array('ldap_ad','session'); # Can be any of the allowed options or a group of them. Required.
...
/* IPCheck Options */
$options['windows'] = False; # Set to true on windows machines

$iplist = array("servers"=>
    array(
        array('description'=>'Linux Machine','ip'=>'192.168.100.11','port'=>'22'),
        array('description'=>'Windows Machine','ip'=>'192.168.100.9','port'=>'445')
    ),
"switches"=>
    array(
        array('description'=>'Switch One','ip'=>'192.168.100.102','port'=>'80'),
        array('description'=>'Switch Two','ip'=>'192.168.100.104','port'=>'80')
    ));
?>
